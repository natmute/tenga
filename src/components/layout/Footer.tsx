        ...
        <div className="grid grid-cols-2 gap-8 md:grid-cols-4">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li><a href="/seller-dashboard" className="hover:text-foreground">Seller Dashboard</a></li>
              <li><a href="/pricing" className="hover:text-foreground">Pricing</a></li>
              <li><a href="/success-stories" className="hover:text-foreground">Success Stories</a></li>
            </ul>
          </div>
